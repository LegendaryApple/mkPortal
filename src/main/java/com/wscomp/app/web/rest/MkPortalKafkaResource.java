...
@RestController
@RequestMapping("/api/mk-portal-kafka")
public class MkPortalKafkaResource {

    private final Logger log = LoggerFactory.getLogger(MkPortalKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public MkPortalKafkaResource(KafkaProperties kafkaProperties) {
